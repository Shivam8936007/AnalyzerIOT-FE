  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-semibold text-slate-700 transition-all duration-500 ease-in-out">Flow Control</h2>
      </div>
      <div
        className={`flex text-slate-500 transition-all duration-500 ease-in-out ${
