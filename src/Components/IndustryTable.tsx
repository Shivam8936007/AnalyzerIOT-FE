            ...
            <tbody className="">
              {industryList?.map((item:any, index:any) => (
                ...
                >
                  ...
                  <td className="px-4 text-cyan-800 text-[.87rem] text-[600] font-Montserrat">
                    {item?.offline_notified ||
                      <span
                      className={`p-[6px] text-slate-200 rounded-md text-xs ${
                        item?.offline_notified ? "bg-green-500" : "bg-[#de4141]"
                      }`}
                    >
                      {item?.offline_notified ? "Online" : "Offline"}
                    </span>
                    }
                  </td>
